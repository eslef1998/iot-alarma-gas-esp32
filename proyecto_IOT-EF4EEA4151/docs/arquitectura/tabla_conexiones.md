...
- Sensor MQ2 (potenciómetro de simulación) -> ESP32 GPIO34 (ADC1)
- Buzzer -> ESP32 GPIO18
...
| :--- | :--- | :--- | :--- |
| MQ2 / sensor analógico | SIG | GPIO34 | Entrada analógica principal del sistema |
| MQ2 / sensor analógico | VCC | 3V3 | Alimentación del sensor |
| MQ2 / sensor analógico | GND | GND | Tierra del sensor |
| Buzzer | + | GPIO18 | Salida PWM / activación sonora |
...
- El buzzer se activa con `tone()` sobre el GPIO18.
